		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group {{ $errors->has('tipo_cooperacion') ? ' has-error ' : ''}}">
					...
					<textarea id="tipo_cooperacion" name="tipo_cooperacion" class="form-control" required>{{$cooperante->tipo_cooperacion}}</textarea>
			...
			<div class="col-md-6">
				<div class="form-group {{ $errors->has('resultados_significativos') ? ' has-error ' : ''}}">
					...
					<textarea id="resultados_significativos" name="resultados_significativos" class="form-control" required>{{$cooperante->resultados_significativos}}</textarea>
