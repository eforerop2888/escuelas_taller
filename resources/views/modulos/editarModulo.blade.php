		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group {{ $errors->has('objetivo') ? ' has-error ' : ''}}">
					<label for="objetivo">Objetivo del Módulo (Máximo 560 caracteres)</label>
					<textarea maxlength="500" id="objetivo" name="objetivo" class="form-control"  required>{{$modulo->objetivo}}</textarea>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group {{ $errors->has('experiencia') ? ' has-error ' : ''}}">
					<label for="experiencia">Experiencia del Maestro (Máximo 560 caracteres)</label>
					<textarea maxlength="500" id="experiencia" name="experiencia" class="form-control"  required>{{$modulo->experiencia}}</textarea>
