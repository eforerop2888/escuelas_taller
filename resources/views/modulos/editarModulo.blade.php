		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group {{ $errors->has('nombre_modulo') ? ' has-error ' : ''}}">
					...
					<input type="text" id="nombre_modulo" name="nombre_modulo" class="form-control" value="{{old('nombre_modulo')}}" required placeholder="Nombre del módulo" autofocus>
			...
			<div class="col-md-6">
				...
				<div class="form-group {{ $errors->has('tipo_modulo') ? ' has-error ' : ''}}">
					<div class="radio">
					  <label>
					    <input type="radio" name="tipo_modulo" id="tipo_modulo1" value="1" checked>
					    Práctico
					  </label>
					</div>
					<div class="radio">
					  <label>
					    <input type="radio" name="tipo_modulo" id="tipo_modulo2" value="2">
					    Teórico
					  </label>
					</div>
