	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group {{ $errors->has('nombre_escuela') ? ' has-error ' : ''}}">
				...
				<input type="text" id="nombre_escuela" name="nombre_escuela" class="form-control" placeholder="Nombre Escuela">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group {{ $errors->has('email') ? ' has-error ' : ''}}">
				...
				<input type="email" id="email" name="email" class="form-control" placeholder="Email Director | Coordinador">
				@if ($errors->has('email'))
                    <span>
